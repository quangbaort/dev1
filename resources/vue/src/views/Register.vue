          ...
          <div class="auth-illustrator-wrapper">
            ...
            <div class="d-flex align-center h-full pa-16 pe-0">
              <v-img
                ...
                height="710"
                class="auth-3d-group"
                :src="require(`@/assets/images/3d-characters/illustration-register-v2-${$vuetify.theme.dark ? 'dark':'light'}.png`).defaults"
              ></v-img>
            </div>
          </div>
        </v-col>
                ...
                <v-card-text>
                  ...
                  >
                    <v-text-field
                      ...
                      :rules="[validators.required, validators.alphaValidator(username, Username)]"
