    ...
    >
      ...
      >
        ...
        >
          ...
          <v-date-picker
            v-model="eventLocal.start"
            @input="isStartDateMenuOpen = false" locale="ja"
        ...
        >
          ...
          <v-date-picker
            v-model="eventLocal.end"
            @input="isEndDateMenuOpen = false" locale="ja"
            :day-format="startDate => new Date(startDate).getDate()" @change="$event => startDate = $event"
          ></v-date-picker>
        </v-menu>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const guestsOptions = [
      { avatar: asset('/images/avatars/1.png'), name: 'Jane Foster' },
      { avatar: asset('/images/avatars/1.png'), name: 'Donna Frank' },
      { avatar: asset('/images/avatars/1.png'), name: 'Gabrielle Robertson' },
      { avatar: asset('/images/avatars/1.png'), name: 'Lori Spears' },
      { avatar: asset('/images/avatars/1.png'), name: 'Sandy Vega' },
      { avatar: asset('/images/avatars/1.png'), name: 'Cheryl May' },
    ]
